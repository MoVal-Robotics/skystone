...
@Autonomous (name = "RedPlateTowardsCenter")
public class RedPlateTowardsCenter extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        move_diagonal(0.3, 25, 1, 1);
        sleep(1000);

        //move forwards
        move_vertical(0.3, 25); //35
        sleep(1000);
        ...
        //move left
        move_horizontal(0.3, -52.5); //-57.5
        sleep(1000);

        //move forwards
        move_vertical(0.3, 27.5); //25
        sleep(1000);
